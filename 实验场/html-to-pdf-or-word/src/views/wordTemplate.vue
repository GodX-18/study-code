<template>
  <div class="threeLevelMain">
    <!-- 报价容器 -->
    <div class="quoteContainer" id="test">
      <!-- 报价顶部信息 -->
      ...
      JSZipUtils.getBinaryContent("input.docx", function(error, content) {
        ...
        html2Canvas(ele, {
         ...
         let imgBase64 = canvas.toDataURL('image/jpeg'); 
          ...
          const htmlString =`<!DOCTYPE html><html lang="en"><head> <meta charset="UTF-8"> <title>Document</title>  </head><body>  <div>
          <img width="850" height="500" src="${imgBase64}"/>  </div> </body></html>` 
          let imageData
          const  opt  =  {orientation:  'landscape'}     
