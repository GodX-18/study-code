    ...
    <div class="content">
      <div class="right-down">
        <el-button
          ...
          >{{ downloadStatus ? "下载中" : "下载" }}</el-button
        >
      </div>
      <div class="container">
        <div class="detail">
      ...
      const htmlString =`<!DOCTYPE html>
        ...
        <head>
            ...
            *{
            ...
            .table-wrap .table tbody tr:nth-of-type(2n) {
              background: #112d87;
              color: #fff;
            }
            ...
            .table-wrap.border > .table > tbody > tr > td {
              border-right: 1px solid #35699c;
              border-bottom: 1px solid #35699c;
            }
            .table-wrap.border > .table > tbody > tr > td:last-of-type {
              border-right: none;
            }

            .table-wrap.nobg > .table > tbody > tr:nth-of-type(odd) {
              background: none;
            }
            </style>
        </head>
